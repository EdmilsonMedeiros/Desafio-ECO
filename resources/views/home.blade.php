...
<div class="container-fluid container-principal">
    <ul class="nav nav-tabs">
        <li class="nav-item active"><a class="nav-link active" href="{{ route('contribuicao.index') }}" data-bs-html="true" data-bs-toggle="tooltip" data-bs-placement="top" title="Manutenções nos próximos 7 dias"><img src="{{ asset('img/doacao (1).png') }}" alt=""> Contribuições</a></li>
        ...
        <li class="nav-item active"><a class="nav-link" href="{{ route('movimentos.index') }}" data-bs-html="true" data-bs-toggle="tooltip" data-bs-placement="top" title="Manutenções nos próximos 7 dias"><img src="{{ asset('img/delivery-man.png') }}" alt=""> Meus movimentos do dia</a></li>
    ...
    <div class="">
        <div class="col-12 title">
            ...
            <a href="#" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#modal-cadastrar-doacao">
                <img src="{{ asset('img/doacao (1).png') }}" alt=""> Cadastrar contribuição</a>
        </div>
        <br>
    </div>
    <div class="card">
            ...
            <tbody>
                @foreach ($contribuicoes as $contribuicao)
                    ...
                    {{ !is_null($contribuicao->status) && $contribuicao->status == 'Recebido' ? '#edffe6' : '' }};">
                        ...
                        <td>{{ isset($contribuicao->mensageiro->name) ? $contribuicao->mensageiro->name : '' }}</td>
