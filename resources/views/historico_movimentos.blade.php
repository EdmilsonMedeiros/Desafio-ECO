...
<div class="container-fluid container-principal">
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a class="nav-link active" href="{{ route('movimentos.historico', Auth::user()->id) }}" data-bs-html="true" data-bs-toggle="tooltip" data-bs-placement="top" title="Manutenções nos próximos 7 dias"><img src="{{ asset('img/historia.png') }}" alt=""> Meu histórico de movimentos</a></li>
    </ul>
                        ...
                        <form action="{{ route('contribuicao.update', $contribuicao->id) }}" method="post">
                            ...
                            <div class="">
                                <div class="form-group">
                                    <div class="">
                                        <select name="status" id="" class="form-control" required {{ isset($contribuicao->status) && $contribuicao->status == 'Recebido' || !($contribuicao->data_finalizacao == null) ? 'disabled' : ''}}>
                                    ...
                                    @if (!(isset($contribuicao->status) && $contribuicao->status == 'Recebido' || !($contribuicao->data_finalizacao == null)))
                                        <div class="">
